        ...
        {loadingCity ? (
          ...
          <>
            ...
            <section className="flex w-full flex-col gap-4">
              ...
              {firstDataForEachDate.map((d, idx) => (
                <ForecastWeatherDetails
                  ...
                  visibility={`${metersToKelometers(d?.visibility ?? 10000)} `}
                  windSpeed={`${covertWindSpeed(d?.wind.speed ?? 1.64)} `}
                />
              ))}
            </section>
          </>
